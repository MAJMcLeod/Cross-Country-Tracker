 ...
 * @author maxaj
 */
public class RaceAddScreen extends javax.swing.JFrame {

    /**
     * Creates new form RaceAddScreen
     */
    ...
    public RaceAddScreen(RaceScreen inTS) {
    ...
    private void initComponents() {
        ...
        lbl_EditTime.setText("Add Race");

        spn_Minutes.setModel(new javax.swing.SpinnerNumberModel(0, 0, 1000000, 1));
    ...
    //Creates a new Race object using the inputted values and inserts it into the database
    private void btn_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SaveActionPerformed
        ...
        db.insertRace(distance, cal);

        TS.RaceScreenPopulate();
        TS.setVisible(true);
        this.setVisible(false);
...
//            java.util.logging.Logger.getLogger(RaceAddScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new RaceAddScreen().setVisible(true);
//            }
//        });
//    }
